...
minlon = -62; maxlon = 80; minlat = -55; maxlat = 110; 
...
load eq_hs.utm;
x=eq_hs;
plot(x(:,1),x(:,2),'LineStyle','none','Marker','.','MarkerSize',1,...
...
figure(2)
clf
minlon = -60; maxlon = 50; minlat = -20; maxlat = 80; 


plot3(x(:,1),x(:,2),x(:,3),'LineStyle','none','Marker','.','MarkerSize',1,...
    'MarkerEdgeColor','k','MarkerFaceColor','k'), hold on;
axis equal;
set(gca,'xlim',[minlon maxlon],'ylim',[minlat maxlat],'zlim',[-20 0],'box','on','FontSize',Fs);
grid on
return
