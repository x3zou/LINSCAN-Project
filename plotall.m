...
ends=importdata("testing_ends.txt");
points=importdata("correlation0.2test.txt");%linscan-scanned data
points2=importdata("testing_clusters_saved.txt");%high quality clusters
input=importdata("catinput.txt");%earthquake catalog xy data
catalog=importdata("catalog_converted.txt");%complete earthquake catalog
pointsdr=zeros(1,7);
